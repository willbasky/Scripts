...
# Default for slimblade
#     BL               TL              BR                                                                                                       TR
# "Button Left" "Button Middle" "Button Right" "Button Wheel Up" "Button Wheel Down" "Button Horiz Wheel Left" "Button Horiz Wheel Right" "Button Side"
#     1                2               3              4                   5                      6                          7                   8

# 2 8 | Middle Side  | TL TR
# 1 3 | Left   Right | BL BR

# set to
#     BL               TL              BR                                                                                                       TR
# "Button Side" "Button Left"  "Button Middle" "Button Wheel Up" "Button Wheel Down" "Button Horiz Wheel Left" "Button Horiz Wheel Right" "Button Right"
#    8                1                2              4                   5                      6                          7                   3
...
if [[ ! -z "$check" ]]; then
  # get id
	...
	xinput set-button-map $mouse_id 8 1 2 4 5 6 7 3
